...
class App extends Component {
  constructor(props){
    ...
    this.state = {
      ...
      welcome:{titile:'Welcome', desc:'Hello, React'},
      contents:[
  ...
  getContent(){
    ...
    if(this.state.mode === 'welcome'){
      _title = this.state.welcome.titile;
      ...
      _article = <CreateContent onSubmit={function (_title, _desc) {
        ...
        // this.state.contents.push({id:max_content_id, titile:_title, desc:_desc});
        // pushはstateを変えてしまう
        // concatは新たなObjectを生成し、返却する
